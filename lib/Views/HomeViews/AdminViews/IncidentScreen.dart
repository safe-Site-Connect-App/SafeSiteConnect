      ...
      title: Row(
        children: [
          Text(
            ...
            style: TextStyle(
              color: Colors.white,
              fontSize: screenWidth * 0.04, // Responsive font size (~16px on 400px screen)
          ...
          if (viewModel.unresolvedCount > 0)
            Padding(
              ...
              child: CircleAvatar(
                radius: screenWidth * 0.025, // Responsive size (~10px on 400px screen)
                backgroundColor: Colors.red,
                child: Text(
                  viewModel.unresolvedCount.toString(),
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: screenWidth * 0.02, // ~8px on 400px screen
      ...
      children: [
        ...
        viewModel.alertes.isEmpty
          ...
          itemBuilder: (context, index) => GestureDetector(
            ...
            child: _buildAlertCard(viewModel.alertes[index], screenWidth),
          ),
        ),
      ],
    );
